<%@ Page  MasterPageFile="~/MasterPage.master" Title="MsgHistory Detail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceholder" Runat="Server">
   <div class="pagecontent">
        <h1>MsgHistory Detail</h1>      

<asp:DetailsView runat="server" DataSourceID="MsgHistoriesDataSource" EmptyDataText="The requested record was not found." ID="MsgHistoriesDetailsView" AutoGenerateRows="False" DataKeyNames="MsgHistoryId"><Fields>
...
<asp:BoundField DataField="Total" InsertVisible="False" HeaderText="Total"></asp:BoundField>
...
<asp:BoundField ReadOnly="True" DataField="MsgHistoryId" InsertVisible="False" HeaderText="MsgHistoryId"></asp:BoundField>
