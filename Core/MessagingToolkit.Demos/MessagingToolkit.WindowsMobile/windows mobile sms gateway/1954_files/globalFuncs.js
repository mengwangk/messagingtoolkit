...
function editWidgetProps(widgetType_ID, host) {
	var winProps = "width=850,height=600,titlebar=0,toolbar=0,location=0,menubar=0,scrollbars=1,resizable=1,channelmode=0,directories=0,status=1";
	window.open("http://"+host+"/cms/popup.cfm?methodId=109&wtId="+widgetType_ID+"&popup=1", "widgetEditor", winProps, true);
}
...
/*function trackClick(contentID,destURL,userID,trackingKey,title) {
	var xmlhttp = false;
	var theURL = "http://cms.devx.com/RSSLinkTracker/RSSLinkTracker.cfm?contentID=" + contentID + "&destURL=" + destURL + "&userID=" + userID + "&trk=" + trackingKey + "&title=" + title;
