...
namespace MessagingToolkit.QRCode.Codec.Reader.Pattern
{
	...
	public class FinderPattern
	{
		...
		internal static Line[] FindLineAcross(bool[][] image)
		{
			...
			canvas.DrawLines(foundLines, MessagingToolkit.QRCode.Helper.Color_Fields.LIGHTGREEN);
			return foundLines;
		}
		...
		internal static Point[] GetCenter(Line[] crossLines)
		{
			...
			{
				canvas.DrawPolygon(foundPoints, MessagingToolkit.QRCode.Helper.Color_Fields.RED);
				return foundPoints;
			}
			else
		...
		internal static int CalcExactVersion(Point[] centers, int[] angle, int[] moduleSize, bool[][] image)
		{
			...
			canvas.DrawPoints(points, MessagingToolkit.QRCode.Helper.Color_Fields.RED);
