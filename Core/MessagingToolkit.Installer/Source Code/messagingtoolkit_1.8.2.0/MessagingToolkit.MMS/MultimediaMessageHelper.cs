...
namespace MessagingToolkit.MMS
{
    ...
    public class MultimediaMessageHelper
    {
        ...
        protected static SortedDictionary<int, PreambleInfo> preambles = null;
        ...
        {
            return Encoding.UTF8.GetString(sourceBytes, 0, sourceBytes.Length);           
        }
        ...
        ***/
...
#else
        public async static Task<Encoding> DetectEncoding(string filename)
#endif
        {
            // Scan for encodings if we haven't done so
            if (preambles == null)
        ...
        protected static void ScanEncodings()
        {
            ...
            preambles = new SortedDictionary<int, PreambleInfo>();
