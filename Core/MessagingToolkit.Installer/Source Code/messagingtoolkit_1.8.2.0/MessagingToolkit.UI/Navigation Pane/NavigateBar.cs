...
namespace MessagingToolkit.UI
{
    ...
    public class NavigateBar : ContainerControl, IComponent
    {
        ...
        public NavigateBar()
        {
            ...
            settings.SettingsFileName = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + System.IO.Path.DirectorySeparatorChar + finfo.Name +  System.IO.Path.DirectorySeparatorChar + "NavigateBarSettings.xml";
