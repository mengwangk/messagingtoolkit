...
namespace MessagingToolkit.Core.Mobile.Extension
{
    ...
    internal sealed class WavecomSunTravellerGateway: BaseMobileGateway<WavecomSunTravellerGateway>, IMobileGateway
    {     
        #region ================== Constructor ===========================================================
        ...
        /// Constructor
        /// </summary>
        public WavecomSunTravellerGateway(MobileGatewayConfiguration config)
            : base(config)
        {
