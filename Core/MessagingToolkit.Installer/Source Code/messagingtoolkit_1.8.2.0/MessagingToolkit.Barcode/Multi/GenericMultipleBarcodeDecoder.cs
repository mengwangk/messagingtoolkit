...
namespace MessagingToolkit.Barcode.Multi
{
    ...
    public class GenericMultipleBarcodeDecoder : MultipleBarcodeDecoder
    {
        ...
        public GenericMultipleBarcodeDecoder(IDecoder decoder)
        {
        ...
        private void DoDecodeMultiple(BinaryBitmap image, Dictionary<DecodeOptions, object> decodingOptions,
        ...
        private static Result TranslateResultPoints(Result result, int xOffset, int yOffset)
        {
            ...
            Result newResult = new Result(result.Text, result.RawBytes, newResultPoints, result.BarcodeFormat);
