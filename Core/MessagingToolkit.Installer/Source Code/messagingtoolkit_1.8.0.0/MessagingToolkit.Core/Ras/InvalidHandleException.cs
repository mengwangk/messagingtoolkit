...
namespace MessagingToolkit.Core.Ras
{
    ...
    public class InvalidHandleException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.InvalidHandleException"/> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.InvalidHandleException"/> class.
        /// </summary>
        /// <param name="handle">The <see cref="MessagingToolkit.Core.Ras.RasHandle"/> that caused the exception.</param>
        ...
        /// <summary>
        /// Gets the <see cref="MessagingToolkit.Core.Ras.RasHandle"/> that caused the exception.
        /// </summary>
