...
namespace MessagingToolkit.Core.Mobile.Extension
{
    ...
    internal sealed class UbineticsGdc201Gateway: BaseMobileGateway<UbineticsGdc201Gateway>, IMobileGateway
    {     
        ...
        /// Constructor
        /// </summary>
        public UbineticsGdc201Gateway(MobileGatewayConfiguration config) : base(config)
        {
