...
namespace MessagingToolkit.Core.Smpp.Packet.Request
{
	...
	public class SmppBind : PDU
	{
		...
		private SmppVersionType _InterfaceVersion = SmppVersionType.Version3_4;
		private TonType _AddressTon = TonType.International;
		private NpiType _AddressNpi = NpiType.ISDN;
		...
		public BindingType BindType
		{
			...
			set
			{
				switch(value)
				{
					...
					{
						CommandID = CommandIdType.BindReceiver;
						break;
					}
					case BindingType.BindAsTransceiver:
					{
						CommandID = CommandIdType.BindTransceiver;
						break;
					}
					case BindingType.BindAsTransmitter:
					{
						CommandID = CommandIdType.BindTransmitter;
						break;
					}
					default:
					{
        ...
        */
		...
		protected override void DecodeSmscResponse()
		{
			...
			BindType = (BindingType)CommandID;
