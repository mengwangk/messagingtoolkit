...
namespace MessagingToolkit.Core.Smpp.Utility
{
	...
	public class SmppStringUtil
	{
		...
		public static string GetStringFromBody(ref byte[] remainder, int startIndex, int endIndex)
		{
			...
			{
                // System.Text.Encoding.GetEncoding("UTF-16BE").GetString(remainder, startIndex, endIndex - startIndex)
        ...
        /// <returns>The string retrieved.</returns>
        public static string GetStringFromBody(ref byte[] remainder, int startIndex, int endIndex, PDU.DataCodingType dataCoding )
        {
            string result;
            ...
            if (endIndex <= remainder.Length)
            {
                ...
                {
                    result = System.Text.Encoding.GetEncoding("UTF-16BE").GetString(remainder, startIndex, endIndex - startIndex);
                }
                else
                {
                    result = System.Text.Encoding.ASCII.GetString(remainder, startIndex, endIndex - startIndex);
        ...
        /// <param name="dataCoding">The data coding.</param>
        /// <returns>The string retrieved.</returns>
        public static string GetCStringFromBody(ref byte[] remainder, int startIndex, int endIndex,PDU.DataCodingType dataCoding)
        {
            string result;
            ...
            if (endIndex <= remainder.Length)
            {
                if (dataCoding == PDU.DataCodingType.Ucs2 || dataCoding == PDU.DataCodingType.UnicodeFlashSms)
                {
                    result = Encoding.GetEncoding("UTF-16BE").GetString(remainder, startIndex, endIndex - startIndex);
                }
                else
                {
                    result = Encoding.ASCII.GetString(remainder, startIndex, endIndex - startIndex);
