...
namespace MessagingToolkit.Core.Helper
{
    ...
    /// IP helper class
    /// </summary>
    internal class IPHelperProcess
    {
    ...
    /// <summary>
    /// IP helper class. Wrapper for iphlpapi.dll
    /// </summary>
    internal class IPHelper
    {
        ...
        public static CMIB_IPNETTABLE GetIpNetTable(bool b_verbose, ref UInt32 error_code)
        {
            ...
            if (b_verbose)
            {
                string str_msg = APIError.GetAPIErrorMessageDescription(error_code);
        ...
        public static string SendArp(string ip, bool b_verbose, ref UInt32 error_code)
        {
            ...
            try
            {
                ...
                if (error_code != 0)
                {
                    if (b_verbose)
                    {
                        string str_msg = "Error retrieving MAC address of " + ip;//+"\r\n"+APIError.GetAPIErrorMessageDescription(error_code);
                        System.Windows.Forms.MessageBox.Show(str_msg, "Error",
                            System.Windows.Forms.MessageBoxButtons.OK,
                            System.Windows.Forms.MessageBoxIcon.Error);
                    }
    ...
    /// IP net table
    /// </summary>
    internal class CMIB_IPNETTABLE
    {
    ...
    public class CMIB_UDPEXROW : CMIB_UDPROW
    {
        ...
        public bool decode_ex(byte[] array)
        {
            ...
            this.pProcess = IPHelperProcess.GetProcessById(this.dwProcessId);
            return true;
        }
    }
