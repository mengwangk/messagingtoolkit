...
{
    [DataContract]
    internal sealed class GetBatteryInfoResponse : BaseResponse
    {

        /// <summary>
        /// Gets or sets the device battery information.
        /// </summary>
        /// <value>
        /// The device battery information.
        /// </value>
        [DataMember(Name = "batteryInfo")]
        public DeviceBatteryInformation DeviceBatteryInformation { get; set; }
