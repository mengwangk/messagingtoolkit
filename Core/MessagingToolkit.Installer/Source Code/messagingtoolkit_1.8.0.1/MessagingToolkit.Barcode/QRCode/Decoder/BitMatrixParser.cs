...
namespace MessagingToolkit.Barcode.QRCode.Decoder
{
    ...
    internal sealed class BitMatrixParser
    {
        ...
        /// This flag has effect only on the <seealso cref="#readFormatInformation()"/> and the
        /// <seealso cref="ReadVersion()"/>. Before proceeding with <seealso cref="ReadCodewords()"/> the
        /// <seealso cref="Mirror()"/> method should be called.
        /// </summary>
        /// <param name="mirror"> Whether to read version and format information mirrored. </param>
