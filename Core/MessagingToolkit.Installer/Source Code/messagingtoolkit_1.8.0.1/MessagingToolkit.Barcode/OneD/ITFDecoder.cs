...
namespace MessagingToolkit.Barcode.OneD
{
    ...
    /// <summary>
    /// <para>Implements decoding of the ITF format, or Interleaved Two of Five.</para>
    ///
    /// <para>This Decoder will scan ITF barcodes of certain lengths only.
    ///  At the moment it reads length 6, 8, 10, 12, 14, 16, 18, 20, 24, and 44 as these have appeared "in the
    ///  wild". Not all lengths are scanned, especially shorter ones, to avoid false positives. This in turn is due to a lack
    ///  of required checksum function.</para>
    ///  
    /// <para>The checksum is optional and is not applied by this Reader. The consumer of the decoded
    /// value will have to apply a checksum if required.</para>
    /// 
    /// <para><a href="http://en.wikipedia.org/wiki/Interleaved_2_of_5">http://en.wikipedia.org/wiki/Interleaved_2_of_5</a>
    /// is a great reference for Interleaved 2 of 5 information.</para>
    /// 
    /// </summary>
    public sealed class ITFDecoder : OneDDecoder
    {
        ...
        private const int MAX_INDIVIDUAL_VARIANCE = (int)(OneDDecoder.PatternMatchResultScaleFactor * 0.78f);
