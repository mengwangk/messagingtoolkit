...
namespace MessagingToolkit.Wap
{
    ...
    public class WAPClient
    {
        ...
        private static LogLevel logLevel = Log.LogLevel.Error;
        private static LogNameFormat logNameFormat = Log.LogNameFormat.NameDate;
        private static LogQuotaFormat logQuotaFormat = Log.LogQuotaFormat.NoRestriction;
        private static int logSizeMax = 0;
        ...
        /// </summary>
        /// <value>The log level.</value>
        static public String LogLocation
        {
            get
            {
                return logLocation;
        ...
        static public LogNameFormat LogNameFormat
        {
            get
            {
        ...
        static public LogQuotaFormat LogQuotaFormat
        {
            get
            {
        ...
        public WAPClient(IPAddress wapGateway, int wapPort, IPAddress localAddress, int localPort)
        {
            ...
            Logger.UseSensibleDefaults(fileName + "_wap", LogLocation, LogLevel, LogNameFormat);
