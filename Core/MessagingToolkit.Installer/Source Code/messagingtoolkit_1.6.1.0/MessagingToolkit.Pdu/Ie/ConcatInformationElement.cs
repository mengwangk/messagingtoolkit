    ...
    public class ConcatInformationElement : InformationElement
    {
        ...
        public static int DefaultConcatType
        {
            ...
            set
            {
                switch (value)
                {
                    ...
                    default:
                        throw new SystemException("Invalid Concat type");
        ...
        virtual public int MpRefNo
        {
            get
            {
                ...
                throw new SystemException("Invalid identifier");
            }
        ...
        internal ConcatInformationElement(byte identifier, byte[] data): base(identifier, data)
        {
            ...
            {
                throw new SystemException("Invalid identifier in data in: " + GetType().Name);
            }
            Validate();
        }
        ...
        private void Validate()
        {
            if (MpMaxNo == 0)
            {
                throw new SystemException("mpMaxNo must be > 0");
            }
            if (MpSeqNo == 0)
            {
                throw new SystemException("mpSeqNo must be > 0");
            }
        }
    }
}