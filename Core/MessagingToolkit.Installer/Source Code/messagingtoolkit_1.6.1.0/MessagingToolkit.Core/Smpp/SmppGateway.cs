...
namespace MessagingToolkit.Core.Smpp 
{
	...
	public class SmppGateway : Component, ISmppGateway
	{
        ...
        public SmppGateway(SmppGatewayConfiguration config)
        {
            ...
            Logger.UseSensibleDefaults(config.LogFile, config.LogLocation, config.LogLevel);
		...
		private void InitGateway()
		{
            ...
            // Initialize the logger
            Logger.UseSensibleDefaults(BaseConfiguration.DefaultLogFileName, string.Empty, LogLevel.Error);
            Logger.LogPrefix = LogPrefix.DtLogLevel;
