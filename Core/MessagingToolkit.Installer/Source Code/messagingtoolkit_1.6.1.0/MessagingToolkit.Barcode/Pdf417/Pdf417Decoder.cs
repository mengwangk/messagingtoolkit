       ...
       public Pdf417Decoder() {
		...
		public Result Decode(BinaryBitmap image, Dictionary<DecodeOptions, object> decodingOptions) {
			...
			if (decodingOptions != null && decodingOptions.ContainsKey(MessagingToolkit.Barcode.DecodeOptions.PureBarcode))
            {
                ...
                DetectorResult detectorResult = new MessagingToolkit.Barcode.Pdf417.Detector.Detector(image).Detect();
		...
		/// </summary>
		///
		/// <seealso cref="M:Com.Google.Zxing.Pdf417.QRCodeReader.ExtractPureBits(null)"/>
		/// <seealso cref="M:Com.Google.Zxing.Pdf417.DataMatrixReader.ExtractPureBits(null)"/>
