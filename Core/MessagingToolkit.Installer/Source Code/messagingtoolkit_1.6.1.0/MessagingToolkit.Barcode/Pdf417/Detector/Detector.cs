    ...
    public sealed class Detector
    {
        ...
        private static ResultPoint[] FindVertices(BitMatrix matrix, bool tryHarder)
        {
            ...
            { // Found the Top Left vertex
                found = false;
                for (int i_0 = height - 1; i_0 > 0; i_0 -= rowStep)
                {
                    int[] loc_1 = FindGuardPattern(matrix, 0, i_0, width, false, START_PATTERN, counters);
                    if (loc_1 != null)
                    {
                        result[1] = new ResultPoint(loc_1[0], i_0);
                        result[5] = new ResultPoint(loc_1[1], i_0);
                        found = true;
                        break;
                    }
                }
            ...
            { // Found the Bottom Left vertex
                found = false;
                for (int i_2 = 0; i_2 < height; i_2 += rowStep)
                {
                    int[] loc_3 = FindGuardPattern(matrix, 0, i_2, width, false, STOP_PATTERN, counters);
                    if (loc_3 != null)
                    {
                        result[2] = new ResultPoint(loc_3[1], i_2);
                        result[6] = new ResultPoint(loc_3[0], i_2);
                        found = true;
                        break;
                    }
                }
            ...
            { // Found the Top right vertex
                found = false;
                for (int i_4 = height - 1; i_4 > 0; i_4 -= rowStep)
                {
                    int[] loc_5 = FindGuardPattern(matrix, 0, i_4, width, false, STOP_PATTERN, counters);
                    if (loc_5 != null)
                    {
                        result[3] = new ResultPoint(loc_5[1], i_4);
                        result[7] = new ResultPoint(loc_5[0], i_4);
                        found = true;
                        break;
                    }
                }
