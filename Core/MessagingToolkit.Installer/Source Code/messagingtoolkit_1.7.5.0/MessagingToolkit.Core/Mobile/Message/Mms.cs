...
namespace MessagingToolkit.Core.Mobile.Message
{
    ...
    {        
        ...
        /// Default SMIL layout
        /// </summary>
        private const string DefaultSmilLayout = @"<smil><head><meta name=""title"" content=""{0}"" /><meta name=""author"" content=""MessagingToolkit"" /><layout><root-layout width=""160"" height=""120""/><region id=""Image"" width=""100%"" height=""80"" left=""0"" top=""0"" /><region id=""Text"" width=""100%"" height=""40"" left=""0"" top=""80"" /></layout></head><body>{1}</body></smil>";
