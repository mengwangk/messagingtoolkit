...
namespace MessagingToolkit.Core.Ras
{
    ...
    /// </para>
    /// <para>
    /// The events raised by this component occur only during a dialing operation, if you need to monitor connection changes made outside of dialing a connection use the <see cref="MessagingToolkit.Core.Ras.RasConnectionWatcher"/> component.
    /// </para>
    /// <para>
    ...
    /// </example>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RasDialer), "MessagingToolkit.Core.Ras.RasDialer.bmp")]
    public sealed partial class RasDialer : RasComponent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.RasDialer"/> class.
        /// </summary>
        public RasDialer()
        {
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="MessagingToolkit.Core.Ras.RasDialer"/> and optionally releases the managed resources.
        /// </summary>
        ...
        /// </summary>
        /// <param name="e">An <see cref="MessagingToolkit.Core.Ras.DialCompletedEventArgs"/> containing event data.</param>
        ...
        /// </summary>
        /// <param name="e">An <see cref="MessagingToolkit.Core.Ras.StateChangedEventArgs"/> containing event data.</param>
