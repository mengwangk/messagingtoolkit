...
namespace MessagingToolkit.Core.Ras
{
    ...
    public sealed class RasEntry : MarshalByRefObject, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.RasEntry"/> class.
        /// </summary>
...
#pragma warning restore 0618
        ...
        /// </summary>
        /// <remarks>See the <see cref="MessagingToolkit.Core.Ras.RasIdleDisconnectTimeout"/> class for possible values.</remarks>
        ...
        /// <param name="device">Required. An <see cref="MessagingToolkit.Core.Ras.RasDevice"/> to use for connecting.</param>
        /// <returns>A new <see cref="MessagingToolkit.Core.Ras.RasEntry"/> object.</returns>
