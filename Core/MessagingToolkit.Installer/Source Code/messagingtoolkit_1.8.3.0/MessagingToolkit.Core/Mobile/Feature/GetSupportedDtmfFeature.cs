...
namespace MessagingToolkit.Core.Mobile.Feature
{
    ...
    /// Get supported DTMF
    /// </summary>
    internal sealed class GetSupportedDtmfFeature: BaseFeature<GetSupportedDtmfFeature>, IFeature
    {
        ...
        /// Default constructor
        /// </summary>
        private GetSupportedDtmfFeature(): base()
        {
        ...
        {
            return "GetSupportedDtmfFeature: Get supported message DTMF";
        }
        ...
        /// <summary>
        /// Return an instance of GetSupportedDtmfFeature
        /// </summary>
        /// <returns>GetSupportedDtmfFeature instance</returns>
        public static GetSupportedDtmfFeature NewInstance()
        {
            return new GetSupportedDtmfFeature();
        }
