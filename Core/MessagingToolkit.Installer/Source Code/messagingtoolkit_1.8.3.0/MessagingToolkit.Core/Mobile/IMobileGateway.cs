...
//#endif
        ...
        /// </summary>
        /// <returns>true if successful, false otherwise</returns>
        bool EnableCallListingNotifications();
        ...
        /// </summary>
        /// <returns>true if successful, false otherwise</returns>
        bool DisableCallListingNotifications();
        ...
        /// </summary>
        CurrentCallInformation[] GetCurrentCalls();
        ...
        /// <returns>true if successful</returns>
        bool CallControl(CallControlBehavior behavior, int index);
        ...
        /// <param name="behavior">Call control behavior</param>
        /// <returns>true if successful</returns>
        bool CallControl(CallControlBehavior behavior);
