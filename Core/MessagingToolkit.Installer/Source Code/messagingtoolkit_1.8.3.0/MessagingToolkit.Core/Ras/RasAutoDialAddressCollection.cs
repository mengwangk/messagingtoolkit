...
namespace MessagingToolkit.Core.Ras
{
    ...
    /// <summary>
    /// Represents a strongly-typed collection of <see cref="MessagingToolkit.Core.Ras.RasAutoDialAddress"/> objects. This class cannot be inherited.
    /// </summary>
    public sealed class RasAutoDialAddressCollection : RasCollection<RasAutoDialAddress>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.RasAutoDialAddressCollection"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Represents a collection of <see cref="MessagingToolkit.Core.Ras.RasAutoDialAddress"/> objects keyed by the entry address.
        /// </summary>
        private class RasAutoDialAddressItemCollection : KeyedCollection<string, RasAutoDialAddress>
        {
            ...
            /// <summary>
            /// Extracts the key for the <see cref="MessagingToolkit.Core.Ras.RasAutoDialAddress"/> object.
            /// </summary>
            /// <param name="item">Required. An <see cref="MessagingToolkit.Core.Ras.RasAutoDialAddress"/> from which to extract the key.</param>
