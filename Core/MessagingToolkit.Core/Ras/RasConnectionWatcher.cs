...
namespace MessagingToolkit.Core.Ras
{
    ...
    /// </example>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RasConnectionWatcher), "MessagingToolkit.Core.Ras.RasConnectionWatcher.bmp")]
    public sealed partial class RasConnectionWatcher : RasComponent, ISupportInitialize
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.RasConnectionWatcher"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Begins the initialization of a <see cref="MessagingToolkit.Core.Ras.RasConnectionWatcher"/> used on a form or other component.
        /// </summary>
        ...
        /// <summary>
        /// Ends the initialization of a <see cref="MessagingToolkit.Core.Ras.RasConnectionWatcher"/> used on a form or other component.
        /// </summary>
        public void EndInit()
        {
        ...
        /// <returns>The <see cref="MessagingToolkit.Core.Ras.RasConnection"/> not found in the collection.</returns>
        ...
        /// </summary>
        /// <param name="e">An <see cref="MessagingToolkit.Core.Ras.RasConnectionEventArgs"/> containing event data.</param>
