        ...
        public bool Execute(IContext context)
        {
            ...
            if (this.Query != null)
            {
                ...
                else
                {
                    ...
                    query[GetMessageQuery.ParameterLastMessageId] = this.Query.LastMessageId.ToString();
                    query[GetMessageQuery.ParameterOffset] = this.Query.Offset.ToString();
                    query[GetMessageQuery.ParameterRowCount] = this.Query.RowCount.ToString();
