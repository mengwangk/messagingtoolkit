...
namespace MessagingToolkit.Barcode.Client.Results
{
    ...
    public sealed class AddressBookDoCoMoResultParser : AbstractDoCoMoResultParser
    {
        ...
        public override ParsedResult Parse(Result result)
        {
            ...
            return new AddressBookParsedResult(ResultParser.MaybeWrap(name), null, pronunciation, phoneNumbers, null, emails, null, null, note, addresses, null, org, birthday, null, urls, null);
        }
