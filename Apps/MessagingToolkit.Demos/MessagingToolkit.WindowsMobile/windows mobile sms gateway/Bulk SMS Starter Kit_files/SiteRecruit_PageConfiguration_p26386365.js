...
SiteRecruit_Config.frequency = CodePlex_SurveyProfile.Frequency;

// Skips the cookie test. Use for debugging.
SiteRecruit_Config.useCookie = CodePlex_SurveyProfile.UseCookie
...
// Iterate through the survey configurations.
        ...
        SiteRecruit_Config.invitations[0].weight = CodePlex_SurveyProfile.Weight;
        SiteRecruit_Config.invitations[0].projectId = 'p26386365';
        SiteRecruit_Config.invitations[0].invitationType = 2;
        SiteRecruit_Config.invitations[0].acceptUrl = 'http://survey2.surveysite.com/wix/p26386365.aspx';
        SiteRecruit_Config.invitations[0].viewUrl = 'http://web.survey-poll.com/tc/CreateLog.aspx';
        SiteRecruit_Config.invitations[0].acceptParams = '&site=672';
        SiteRecruit_Config.invitations[0].viewParams = 'log=comscore/view/p26386365-view.log&site=672';
        SiteRecruit_Config.invitations[0].invitationContent = ' <table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/site/library/svy/survey_CodePlexlogo.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/site/library/svy/close_v2.gif" /></a><br /> <img src="/site/library/svy/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 0 0 15px 0;">Microsoft is conducting an online survey to understand your opinion of the CodePlex Web site. If you choose to participate, the online survey will be presented to you when you leave the CodePlex Web site.  <br /> <br /> Would you like to participate?</div>  <div align="center" style="margin: 0; padding: 0"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 15px 0 2px 0;"><a href="http://survey.surveysite.com/wi/p26386365/privacy_p26386365_672.html" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/site/library/svy/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
        ...
        SiteRecruit_Config.invitations[0].horizontalAlignment = 2;
        SiteRecruit_Config.invitations[0].verticalAlignment = 2;
        ...
        SiteRecruit_Config.invitations[0].autoCentering = false;
    
            
            
                    SiteRecruit_Config.invitations[0].trackerUrl = CodePlex_SurveyProfile.PageUrl;
...
if (SiteRecruit_Globals.isInternetExplorer || SiteRecruit_Globals.isMozilla)
{
    ...
    {  
        SiteRecruit_Globals.startBuilder = true;
                    ...
                    var uniqueUrl = '/site/library/svy/SiteRecruit_InvitationBuilder.js?' + (new Date()).getTime();
