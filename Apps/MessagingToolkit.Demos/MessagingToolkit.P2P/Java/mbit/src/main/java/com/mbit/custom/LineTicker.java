 ...
 *         Created : Jun 12, 2006 12:00:26 AM
 * @version : $Id:
 */
public class LineTicker extends CustomItem implements ItemCommandListener {
     ...
     * @param width
     */
    public LineTicker(String str, int width) {
        super("");
    ...
    class TickerTask extends TimerTask {
        ...
        public TickerTask(LineTicker ticker) {
            this.ticker = ticker;
        }
