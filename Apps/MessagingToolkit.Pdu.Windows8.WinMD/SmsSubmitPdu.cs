...
namespace MessagingToolkit.Pdu
{
    ...
    public class SmsSubmitPdu : Pdu
    {
        ...
        private double validityPeriod = -1;
        private DateTimeOffset validityPeriodTimeStamp;
        ...
        public int TpRd
        {
            get
            {
                return GetFirstOctetField((int)RejectDuplicates.TpRdMask);
            }
            set
            {
                SetFirstOctetField((int)RejectDuplicates.TpRdMask, value, new int[] { (int)RejectDuplicates.TpRdAcceptDuplicates, (int)RejectDuplicates.TpRdRejectDuplicates });
            }
        ...
        public int TpVpf
        {
            get
            {
                return GetFirstOctetField((int)ValidityPeriodFormat.TpVpfMask);
            }

            set
            {
                SetFirstOctetField((int)ValidityPeriodFormat.TpVpfMask, value, new int[] { (int)ValidityPeriodFormat.TpVpfInteger, (int)ValidityPeriodFormat.TpVpfNone, (int)ValidityPeriodFormat.TpVpfTimestamp });
            }
        }
        ...
        public int TpRp
        {
            get
            {
                return GetFirstOctetField((int)ReplyPath.TpRpMask);
            }

            set
            {
                SetFirstOctetField((int)ReplyPath.TpRpMask, value, new int[] { (int)ReplyPath.TpRpWithRp, (int)ReplyPath.TpRpNoRp });
            }
        ...
        public int TpSrr
        {
            get
            {
                return GetFirstOctetField((int)StatusReportRequest.TpSrrMask);
            }
            set
            {
                SetFirstOctetField((int)StatusReportRequest.TpSrrMask, value, new int[] { (int)StatusReportRequest.TpSrrNoReport, (int)StatusReportRequest.TpSrrReport });
            }
        ...
        virtual public DateTimeOffset ValidityTimestamp
        {
            get
            {
        ...
        public bool HasTpRd()
        {
            return GetFirstOctetField((int)RejectDuplicates.TpRdMask) == (int)RejectDuplicates.TpRdRejectDuplicates;
        }
        ...
        {
            return GetFirstOctetField((int)ValidityPeriodFormat.TpVpfMask) != (int)ValidityPeriodFormat.TpVpfNone;
        }
        ...
        {
            return GetFirstOctetField((int)StatusReportRequest.TpSrrMask) == (int)StatusReportRequest.TpSrrReport;
        }
        ...
        {
            return GetFirstOctetField((int)ReplyPath.TpRpMask) == (int)ReplyPath.TpRpWithRp;
        }
        ...
        public void AddReplyPath(string address, int addressType)
        {
            ...
            this.TpRp = (int)ReplyPath.TpRpWithRp;
