...
namespace MessagingToolkit.Barcode.Common
{
    ...
    public sealed class BitMatrix
    {
        ...
        public bool Get(int x, int y)
        {
            ...
            if (offset >= bits.Length) return false;    // Added boundary check - Oct 13 2012
        ...
        /// <summary>
        /// Left padding of the barcode.
        /// </summary>
        public int LeftPadding { get; set; }

        /// <summary>
        /// Top padding of the barcode.
        /// </summary>
        public int TopPadding { get; set; }

        /// <summary>
        /// Actual width of the barcode.
        /// </summary>
        public int ActualWidth { get; set; }

        /// <summary>
        /// Actual height of the barcode.
        /// </summary>
