...
namespace MessagingToolkit.Barcode.Client.Results
{
    ...
    internal sealed class ExpandedProductResultParser : ResultParser
    {
        public override ParsedResult Parse(Result result)
        {
            ...
            return new ExpandedProductParsedResult(rawText, productID, sscc, lotNumber, productionDate, packagingDate, bestBeforeDate, expirationDate, weight, weightType, weightIncrement, price, priceIncrement,
