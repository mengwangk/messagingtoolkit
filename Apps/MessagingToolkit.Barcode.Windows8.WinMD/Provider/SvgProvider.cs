...
namespace MessagingToolkit.Barcode.Provider
{
    ...
    /// SVG provider.
    /// </summary>
    public sealed class SvgProvider : IOutputProvider
    {
        /// <summary>
        ...
        private void Create(Svg image, BitMatrix matrix, BarcodeFormat format, string content, IDictionary<EncodeOptions, object> options)
        {
    ...
    public sealed class Svg : IOutput
    {
