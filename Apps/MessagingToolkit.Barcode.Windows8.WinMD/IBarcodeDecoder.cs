...
namespace MessagingToolkit.Barcode
{
    ...
    /// </summary>
    internal interface IBarcodeDecoder : IDecoder
    {
        /// <summary>
...
#else
        Result Decode(WriteableBitmap image, IDictionary<DecodeOptions, object> decodingOptions);
#endif
        ...
        /// The result data or null
        /// </returns>
        Result Decode(byte[] rawRGB, int width, int height, BitmapFormat format, IDictionary<DecodeOptions, object> decodingOptions);
        ...
        /// The result data  or a empty list
        /// </returns>
        Result[] DecodeMultiple(byte[] rawRGB, int width, int height, BitmapFormat format, IDictionary<DecodeOptions, object> decodingOptions);
        ...
        ///  The result data  or a empty list
        /// </returns>
        Result[] DecodeMultiple(BinaryBitmap binaryBitmap, IDictionary<DecodeOptions, object> decodingOptions);
