...
{
    internal abstract class AbstractRssDecoder : OneDDecoder
    {

        private static int MaxAvgVariance = (int)(MessagingToolkit.Barcode.OneD.OneDDecoder.PatternMatchResultScaleFactor * 0.2f);
        private static int MaxIndividualVariance = (int)(MessagingToolkit.Barcode.OneD.OneDDecoder.PatternMatchResultScaleFactor * 0.45f);
