...
namespace MessagingToolkit.QRCode.Codec.Data
{
    ...
    public class QRCodeSymbol
    {
        ...
        virtual public int NumErrorCollectionCode
        {
            get
            {
                return numErrorCorrectionCode[version - 1][errorCollectionLevel];
            }
        ...
        virtual public int[] Blocks
        {
            get
            {
                ...
                int x = width - 1;
                int y = height - 1;
                List<bool> codeBits = new List<bool>(10);
                List<Int32> codeWords = new List<Int32>(10);
                int tempWord = 0;
                int figure = 7;
                int isNearFinish = 0;
                bool READ_UP = true;
