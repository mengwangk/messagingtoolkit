...
namespace MessagingToolkit.Core.Utilities
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            if (!IsAdministrator())
            {
                MessageBox.Show("Please run this demo under Admministrator privilege to avoid any system security constraints", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
