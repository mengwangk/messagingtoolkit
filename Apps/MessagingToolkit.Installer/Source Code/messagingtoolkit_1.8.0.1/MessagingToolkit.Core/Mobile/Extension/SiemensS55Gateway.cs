...
namespace MessagingToolkit.Core.Mobile.Extension
{
    ...
    internal sealed class SiemensS55Gateway: BaseMobileGateway<SiemensS55Gateway>, IMobileGateway
    {     
        ...
        /// Constructor
        /// </summary>
        public SiemensS55Gateway(MobileGatewayConfiguration config): base(config)
        {
