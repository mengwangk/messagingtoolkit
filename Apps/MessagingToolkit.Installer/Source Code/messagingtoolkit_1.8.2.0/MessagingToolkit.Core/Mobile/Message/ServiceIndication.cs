...
namespace MessagingToolkit.Core.Mobile.Message
{
    ...
    internal class ServiceIndication
    {
        ...
        override public string ToString()
        {
            ...
            str = String.Concat(str, "Href = ", Href, "\r\n");
            str = String.Concat(str, "Text = ", Text, "\r\n");
            str = String.Concat(str, "CreatedAt = ", CreatedAt, "\r\n");
            str = String.Concat(str, "ExpiresAt = ", ExpiresAt, "\r\n");
            str = String.Concat(str, "Action = ", Action, "\r\n");
            return str;
        }
	}
}
