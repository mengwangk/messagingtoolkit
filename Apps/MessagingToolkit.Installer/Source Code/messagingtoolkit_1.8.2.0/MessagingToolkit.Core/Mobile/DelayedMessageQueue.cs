...
namespace MessagingToolkit.Core.Mobile
{
    ...
    internal class DelayedMessageQueue: List<IMessage>
    {
        ...
        /// </summary>
        public DelayedMessageQueue(PersistedMessageType messageType)
            : base()
        {
        ...
        public bool Persist
        {
            ...
            set
            {
                ...
                {
                    Load(this.persistedMessageType);
                }
            }
        }
            ...
            if (Persist)
            {
                try
                {
                    ...
                    */
                    ...
                    LoadPersistedMessage<Sms>(smsFolder);
                    LoadPersistedMessage<Mms>(mmsFolder);
                    LoadPersistedMessage<PostMessage>(httpMessageFolder);
                    this.isLoaded = true;
                }
                catch (Exception ex)
                {
        ...
        /// <summary>
        /// Loads the specified message type.
        /// </summary>
        /// <param name="messageType">Type of the message.</param>
        /// <returns></returns>
        private bool Load(PersistedMessageType messageType)
        {
        ...
        private void LoadPersistedMessage<T>(string folder) where T : IMessage
        {
