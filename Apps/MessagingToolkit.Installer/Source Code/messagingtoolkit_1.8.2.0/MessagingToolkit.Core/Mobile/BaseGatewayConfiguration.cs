...
namespace MessagingToolkit.Core.Mobile
{
    ...
    public class BaseGatewayConfiguration : BaseConfiguration
    {
        ...
        */
        ...
        /// <summary>
        /// Use HTTP transport for MMS sending and receiving. Default to true since version 1.8.2.
        /// </summary>
        [XmlAttribute]
        public bool UseHttpTransportForMMS
        {
            get;
            set;
        }
        ...
        /// </value>
        [XmlAttribute]
        public int CommandWaitInterval
        {
            get;
            set;
        }
        ...
        /// </value>
        [XmlAttribute]
        public int CommandWaitRetryCount
        {
            get;
            set;
        }
