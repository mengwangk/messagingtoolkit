...
namespace MessagingToolkit.Core.Ras
{
    ...
    /// </example>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RasDialDialog), "MessagingToolkit.Core.Ras.RasDialDialog.bmp")]
    public sealed class RasDialDialog : RasCommonDialog
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.RasDialDialog"/> class.
        /// </summary>
