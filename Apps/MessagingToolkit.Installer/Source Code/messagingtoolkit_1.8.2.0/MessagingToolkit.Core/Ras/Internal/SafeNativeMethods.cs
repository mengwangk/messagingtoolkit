...
namespace MessagingToolkit.Core.Ras.Internal
{
    ...
    internal class SafeNativeMethods : ISafeNativeMethods
    {
        ...
        /// </summary>
        /// <param name="pLuid">Pointer to a <see cref="MessagingToolkit.Core.Ras.Luid"/> structure that upon return, receives the generated LUID instance.</param>
        ...
        /// Lists all active remote access service (RAS) connections.
        /// </summary>
        /// <param name="lpRasConn">Pointer to a buffer that, on output, receives an array of <see cref="MessagingToolkit.Core.Ras.RasConnection"/> structures.</param>
        ...
        /// <param name="lpRasConnStatus">Pointer to a <see cref="MessagingToolkit.Core.Ras.RasConnectionStatus"/> structure that upon return contains the status information for the handle specified by <paramref name="hRasConn"/>.</param>
        /// <returns>If the function succeeds, the return value is zero.</returns>
        [DllImport("rasapi32.dll", CharSet = CharSet.Unicode)]
