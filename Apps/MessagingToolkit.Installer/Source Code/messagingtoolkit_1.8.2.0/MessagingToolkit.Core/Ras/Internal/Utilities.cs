...
namespace MessagingToolkit.Core.Ras.Internal
{
    ...
    internal static class Utilities
    {
        ...
        public static NativeMethods.RASEO GetRasEntryOptions(RasEntry entry)
        {
            ...
            if (entry != null)
            {
                options |= (NativeMethods.RASEO)Utilities.SetFlag(entry.CountryId != 0 || entry.CountryCode != 0 || entry.AreaCode != null, NativeMethods.RASEO.UseCountryAndAreaCodes);
                ...
                options |= (NativeMethods.RASEO)Utilities.SetFlag(entry.Options.TerminateBeforeDial, NativeMethods.RASEO.TerminateBeforeDial);
                options |= (NativeMethods.RASEO)Utilities.SetFlag(entry.Options.TerminateAfterDial, NativeMethods.RASEO.TerminateAfterDial);
        ...
        public static void SetRasEntryOptions(RasEntry entry, NativeMethods.RASEO value)
        {
            if (entry != null)
            {
                ...
                options.TerminateBeforeDial = Utilities.HasFlag(value, NativeMethods.RASEO.TerminateBeforeDial);
                options.TerminateAfterDial = Utilities.HasFlag(value, NativeMethods.RASEO.TerminateAfterDial);
...
#pragma warning restore 0618
        ...
        /// </summary>
        /// <param name="handle">A <see cref="MessagingToolkit.Core.Ras.RasHandle"/> to check.</param>
