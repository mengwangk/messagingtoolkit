...
namespace MessagingToolkit.Core.Ras
{
    ...
    public class RasConnectionEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingToolkit.Core.Ras.RasConnectionEventArgs"/> class.
        /// </summary>
        /// <param name="connection">The <see cref="MessagingToolkit.Core.Ras.RasConnection"/> that caused the event.</param>
