...
namespace MessagingToolkit.Barcode.DataMatrix.Encoder
{
    internal class DataMatrixEncode
    {
        #region Fields
        int _method;
        DataMatrixScheme _scheme;
        DataMatrixSymbolSize _sizeIdxRequest;
        int _marginSize;
        int _moduleSize;
        DataMatrixPackOrder _pixelPacking;
        DataMatrixFlip _imageFlip;
        int _rowPadBytes;
        DataMatrixMessage _message;
        DataMatrixImage _image;
        DataMatrixRegion _region;
        bool[,] _rawData;
        int _width;
        int _height;
        int _quietZone;
        ...
        internal bool EncodeDataMatrix(Color? foreColor, Color? backColor, byte[] inputString, bool encodeRaw)
        {
            ...
            DataMatrixSymbolSize sizeIdx = this._sizeIdxRequest;
            ...
            if (sizeIdx == DataMatrixSymbolSize.SymbolSquareAuto || sizeIdx == DataMatrixSymbolSize.SymbolRectAuto)
            {
            ...
            int padCount = this.AddPadChars(buf, ref dataWordCount, DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolDataWords, sizeIdx));

            /* XXX we can remove a lot of this redundant data */
            this._region = new DataMatrixRegion();
            this._region.SizeIdx = sizeIdx;
            this._region.SymbolRows = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolRows, sizeIdx);
            this._region.SymbolCols = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolCols, sizeIdx);
            this._region.MappingRows = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribMappingMatrixRows, sizeIdx);
            this._region.MappingCols = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribMappingMatrixCols, sizeIdx);

            /* Allocate memory for message and array */
            this._message = new DataMatrixMessage(sizeIdx, DataMatrixFormat.Matrix) {PadCount = padCount};
            ...
            */
            ...
            DataMatrixDecode.ModulePlacementEcc200(this._message.Array, this._message.Code,
                  this._region.SizeIdx, DataMatrixConstants.DataMatrixModuleOnRGB);

            //this._marginSize = (this._region.SymbolCols * this.QuietZone);
            //this._moduleSize = (width - (2 * _marginSize)) / this._region.SymbolCols;
            //if (this._moduleSize == 0) this._moduleSize = 3;
            ...
            this._image = new DataMatrixImage(pxl, width, height, this._pixelPacking)
        ...
        internal bool EncodeDataMosaic(byte[] inputString)
        {
            ...
            DataMatrixSymbolSize splitSizeIdxAttempt, splitSizeIdxLast;
            ...
            DataMatrixSymbolSize sizeIdx = sizeIdxRequest = this._sizeIdxRequest;
            ...
            DataMatrixSymbolSize splitSizeIdxFirst = this.FindCorrectSymbolSize(tmpInputSize, sizeIdxRequest);
            if (splitSizeIdxFirst == DataMatrixSymbolSize.SymbolShapeAuto)
                return false;
            ...
            {
                splitSizeIdxLast = DataMatrixSymbolSize.Symbol144x144;
            }
            else if (sizeIdxRequest == DataMatrixSymbolSize.SymbolRectAuto)
            {
                splitSizeIdxLast = DataMatrixSymbolSize.Symbol16x48;
            }
            else
            {
            ...
            DataMatrixEncode encGreen = new DataMatrixEncode(this);
            DataMatrixEncode encBlue = new DataMatrixEncode(this);
            ...
            int mappingRows = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribMappingMatrixRows, splitSizeIdxAttempt);
            int mappingCols = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribMappingMatrixCols, splitSizeIdxAttempt);
            ...
            for (row = 0; row < mappingRows; row++)
            {
                ...
                {
                    this._message.Array[row * mappingCols + col] &= (byte)(0xff ^ (DataMatrixConstants.DataMatrixModuleAssigned | DataMatrixConstants.DataMatrixModuleVisited));
                }
            }

            DataMatrixDecode.ModulePlacementEcc200(this._message.Array, encGreen.Message.Code, this._region.SizeIdx, DataMatrixConstants.DataMatrixModuleOnGreen);
            ...
            DataMatrixDecode.ModulePlacementEcc200(this._message.Array, encBlue.Message.Code, this._region.SizeIdx, DataMatrixConstants.DataMatrixModuleOnBlue);
        ...
        private void PrintPatternRaw()
        {
            ...
            for (int symbolRow = 0; symbolRow < this._region.SymbolRows; symbolRow++)
            {
                for (int symbolCol = 0; symbolCol < this._region.SymbolCols; symbolCol++)
                {
                    ...
                    this._rawData[symbolCol, this._region.SymbolRows - symbolRow - 1] = ((moduleStatus & DataMatrixConstants.DataMatrixModuleOnBlue) != 0x00);
                }
            }
        }
        ...
        private void PrintPattern(Color? foreColor, Color? backColor)
        {
            ...
            DataMatrixMatrix3 m1 = DataMatrixMatrix3.Translate(txy, txy);
            DataMatrixMatrix3 m2 = DataMatrixMatrix3.Scale(this._moduleSize, this._moduleSize);
            DataMatrixMatrix3 rxfrm = m2 * m1;
            ...
            for (symbolRow = 0; symbolRow < this._region.SymbolRows; symbolRow++)
            {
                ...
                {
                    DataMatrixVector2 vIn = new DataMatrixVector2(symbolCol, symbolRow);
                    DataMatrixVector2 vOut = vIn * rxfrm;
                    ...
                    for (int i = pixelRow; i < pixelRow + this._moduleSize; i++)
                    {
                        for (int j = pixelCol; j < pixelCol + this._moduleSize; j++)
                        {
                            ...
                            {
                                rgb[0] = ((moduleStatus & DataMatrixConstants.DataMatrixModuleOnRed) != 0x00) ? foreColor.Value.B : backColor.Value.B;
                                rgb[1] = ((moduleStatus & DataMatrixConstants.DataMatrixModuleOnGreen) != 0x00) ? foreColor.Value.G : backColor.Value.G;
                                rgb[2] = ((moduleStatus & DataMatrixConstants.DataMatrixModuleOnBlue) != 0x00) ? foreColor.Value.R : backColor.Value.R;
                            }
                            else
                            {
                                rgb[0] = ((moduleStatus & DataMatrixConstants.DataMatrixModuleOnBlue) != 0x00) ? 0 : 255;
                                rgb[1] = ((moduleStatus & DataMatrixConstants.DataMatrixModuleOnGreen) != 0x00) ? 0 : 255;
                                rgb[2] = ((moduleStatus & DataMatrixConstants.DataMatrixModuleOnRed) != 0x00) ? 0 : 255;
                            }
        ...
        private int AddPadChars(byte[] buf, ref int dataWordCount, int paddedSize)
        {
            ...
            {
                padCount++;
                buf[dataWordCount] = Randomize253State(DataMatrixConstants.DataMatrixCharAsciiPad, dataWordCount + 1);
                dataWordCount++;
            }
        ...
        int EncodeDataCodewords(byte[] buf, byte[] inputString, ref DataMatrixSymbolSize sizeIdx)
        {
            int dataWordCount;
            ...
            if (sizeIdx == DataMatrixSymbolSize.SymbolShapeAuto)
                return 0;

            return dataWordCount;
        }

        private DataMatrixSymbolSize FindCorrectSymbolSize(int dataWords, DataMatrixSymbolSize sizeIdxRequest)
        {
            ...
            if (sizeIdxRequest == DataMatrixSymbolSize.SymbolSquareAuto || sizeIdxRequest == DataMatrixSymbolSize.SymbolRectAuto)
            {
                ...
                {
                    idxBeg = 0;
                    idxEnd = DataMatrixConstants.DataMatrixSymbolSquareCount;
                }
                else
                {
                    idxBeg = DataMatrixConstants.DataMatrixSymbolSquareCount;
                    idxEnd = DataMatrixConstants.DataMatrixSymbolSquareCount + DataMatrixConstants.DataMatrixSymbolRectCount;
                }

                for (sizeIdx = (DataMatrixSymbolSize)idxBeg; sizeIdx < (DataMatrixSymbolSize)idxEnd; sizeIdx++)
                {
                    if (DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolDataWords, sizeIdx) >= dataWords)
                    {
                        break;
                    }
                }

                if (sizeIdx == (DataMatrixSymbolSize)idxEnd)
                {
                    return DataMatrixSymbolSize.SymbolShapeAuto;
                }
            }
            ...
            if (dataWords > DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolDataWords, sizeIdx))
            {
                return DataMatrixSymbolSize.SymbolShapeAuto;
            }
        ...
        private int EncodeAutoBest(byte[] buf, byte[] codewords)
        {
            ...
            for (targetScheme = DataMatrixScheme.SchemeAscii; targetScheme <= DataMatrixScheme.SchemeBase256; targetScheme++)
            {
                DataMatrixChannel channel = (optimal.Channels[(int)targetScheme]);
                InitChannel(channel, codewords);
            ...
            DataMatrixChannel winner = optimal.Channels[(int)DataMatrixScheme.SchemeAscii];
            for (targetScheme = DataMatrixScheme.SchemeAscii + 1; targetScheme <= DataMatrixScheme.SchemeBase256; targetScheme++)
            {
                if (optimal.Channels[(int)targetScheme].Invalid != DataMatrixChannelStatus.ChannelValid)
                {
                    continue;
                }
        ...
        private DataMatrixChannel FindBestChannel(DmtxChannelGroup group, DataMatrixScheme targetScheme)
        {
            DataMatrixChannel winner = null;

            for (DataMatrixScheme encFrom = DataMatrixScheme.SchemeAscii; encFrom <= DataMatrixScheme.SchemeBase256; encFrom++)
            {

                DataMatrixChannel channel = group.Channels[(int)encFrom];
                ...
                if ((channel.Invalid & DataMatrixChannelStatus.ChannelUnsupportedChar) != 0)
                {
                    winner = channel;
                    break;
                }
                ...
                if ((channel.Invalid & DataMatrixChannelStatus.ChannelCannotUnlatch) != 0)
                {
                    continue;
                }
        ...
        private bool EncodeBase256Codeword(DataMatrixChannel channel)
        {
            ...
            headerByte[0] = DataMatrixMessage.UnRandomize255State(channel.EncodedWords[firstBytePtrIndex], channel.FirstCodeWord / 12 + 1);
            ...
            else
            {
                ...
                newDataLength += DataMatrixMessage.UnRandomize255State(channel.EncodedWords[firstBytePtrIndex + 1], channel.FirstCodeWord / 12 + 2);
            }
            ...
            if (newDataLength == 250)
            {
                ...
                {
                    byte valueTmp = DataMatrixMessage.UnRandomize255State(channel.EncodedWords[i], i + 1);
        ...
        private void CheckForEndOfSymbolEdifact(DataMatrixChannel channel)
        {
            ...
            DataMatrixSymbolSize sizeIdx = this.FindCorrectSymbolSize(currentByte, DataMatrixSymbolSize.SymbolSquareAuto);
            /* XXX test for sizeIdx == DmtxUndefined here */
            int symbolCodewords = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolDataWords, sizeIdx) - currentByte;
                  ...
                  (symbolCodewords == 1 || symbolCodewords == 2))
            {
                ...
                { /* (a,b,d,e,f) */
                    ChangeEncScheme(channel, DataMatrixScheme.SchemeAscii, DmtxUnlatch.Implicit);

                    /* XXX this loop should produce exactly asciiWords codewords ... assert somehow? */
                    for (int i = 0; i < edifactValues; i++)
                    {
                        bool err = EncodeNextWord(channel, DataMatrixScheme.SchemeAscii);
                        if (err == false)
                        {
                            return;
                        }
            ...
            { /* (h) */
                ChangeEncScheme(channel, DataMatrixScheme.SchemeAscii, DmtxUnlatch.Explicit);
            }
            /* else (i) -- do nothing */
        ...
        private void PushInputWord(DataMatrixChannel channel, byte codeword)
        {
            ...
            switch (channel.EncScheme)
            {
                ...
                case DataMatrixScheme.SchemeEdifact:
                    ...
                    DataMatrixQuadruplet quad = GetQuadrupletValues(channel.EncodedWords[startByte],
        ...
        private bool EncodeTripletCodeword(DataMatrixChannel channel)
        {
            ...
            if (channel.EncScheme != DataMatrixScheme.SchemeX12 &&
                channel.EncScheme != DataMatrixScheme.SchemeText &&
                channel.EncScheme != DataMatrixScheme.SchemeC40)
            {
                throw new Exception("Invalid encoding scheme selected!");
            }
        ...
        private int GetC40TextX12Words(int[] outputWords, byte inputWord, DataMatrixScheme encScheme)
        {
            if (encScheme != DataMatrixScheme.SchemeX12 &&
                encScheme != DataMatrixScheme.SchemeText &&
                encScheme != DataMatrixScheme.SchemeC40)
            {
                throw new Exception("Invalid encoding scheme selected!");
            }
            ...
            if (inputWord > 127)
            {
                ...
                outputWords[count++] = DataMatrixConstants.DataMatrixCharTripletShift2;
            ...
            { /* encScheme is C40 or Text */
                if (inputWord <= 31)
                {
                    outputWords[count++] = DataMatrixConstants.DataMatrixCharTripletShift1;
                ...
                else if (inputWord <= 90 && encScheme == DataMatrixScheme.SchemeC40)
                {
                    outputWords[count++] = inputWord - 51;
                }
                else if (inputWord <= 90 && encScheme == DataMatrixScheme.SchemeText)
                {
                    outputWords[count++] = DataMatrixConstants.DataMatrixCharTripletShift3;
                ...
                else if (inputWord == 96 && encScheme == DataMatrixScheme.SchemeText)
                {
                    outputWords[count++] = DataMatrixConstants.DataMatrixCharTripletShift3;
                    outputWords[count++] = 0;
                }
                else if (inputWord <= 122 && encScheme == DataMatrixScheme.SchemeText)
                {
        ...
        private bool ProcessEndOfSymbolTriplet(DataMatrixChannel channel, DataMatrixTriplet triplet, int tripletCount, int inputCount)
        {
            bool err;
            ...
            DataMatrixSymbolSize sizeIdx = this.FindCorrectSymbolSize(currentByte + ((inputCount == 3) ? 2 : inputCount), this._sizeIdxRequest);

            if (sizeIdx == DataMatrixSymbolSize.SymbolShapeAuto)
                return false;

            /* XXX test for sizeIdx == DmtxUndefined here */
            int remainingCodewords = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolDataWords, sizeIdx) - currentByte;
            ...
            {
                ChangeEncScheme(channel, DataMatrixScheme.SchemeAscii, DmtxUnlatch.Implicit);
                err = EncodeNextWord(channel, DataMatrixScheme.SchemeAscii);
                if (err == false)
                    return false;
            ...
            else
            {
                ...
                remainingCodewords = DataMatrixCommon.GetSymbolAttribute(DataMatrixSymAttribute.SymAttribSymbolDataWords, sizeIdx) - currentByte;
        ...
        private bool EncodeAsciiCodeword(DataMatrixChannel channel)
        {
            ...
            /* Extended ASCII char */
            if (inputValue == DataMatrixConstants.DataMatrixCharFNC1)
            {
                PushInputWord(channel, DataMatrixConstants.DataMatrixCharFNC1);
                IncrementProgress(channel, 12);
                channel.InputIndex++;
                return true;
            }
            if (inputValue >= 128)
            {
                PushInputWord(channel, DataMatrixConstants.DataMatrixCharAsciiUpperShift);
                IncrementProgress(channel, 12);
                inputValue -= 128;
            }
        ...
        private void ChangeEncScheme(DataMatrixChannel channel, DataMatrixScheme targetScheme, DmtxUnlatch unlatchType)
        {
            if (channel.EncScheme == targetScheme)
            {
            ...
            switch (channel.EncScheme)
            {
                ...
                case DataMatrixScheme.SchemeX12:
                    ...
                    {
                        PushInputWord(channel, (byte)DataMatrixConstants.DataMatrixCharTripletUnlatch);
                        IncrementProgress(channel, 12);
                    }
                    break;
                ...
                case DataMatrixScheme.SchemeEdifact:
                    ...
                    if (unlatchType == DmtxUnlatch.Explicit)
                    {
                        PushInputWord(channel, (byte)DataMatrixConstants.DataMatrixCharEdifactUnlatch);
                        IncrementProgress(channel, 9);
                    }
            ...
            switch (targetScheme)
            {
                case DataMatrixScheme.SchemeAscii:
                    ...
                    break;
                case DataMatrixScheme.SchemeC40:
                    PushInputWord(channel, DataMatrixConstants.DataMatrixCharC40Latch);
                    IncrementProgress(channel, 12);
                    break;
                case DataMatrixScheme.SchemeText:
                    PushInputWord(channel, DataMatrixConstants.DataMatrixCharTextLatch);
                    IncrementProgress(channel, 12);
                    break;
                case DataMatrixScheme.SchemeX12:
                    PushInputWord(channel, DataMatrixConstants.DataMatrixCharX12Latch);
                    IncrementProgress(channel, 12);
                    break;
                case DataMatrixScheme.SchemeEdifact:
                    PushInputWord(channel, DataMatrixConstants.DataMatrixCharEdifactLatch);
                    IncrementProgress(channel, 12);
                    break;
                case DataMatrixScheme.SchemeBase256:
                    PushInputWord(channel, DataMatrixConstants.DataMatrixCharBase256Latch);
                    IncrementProgress(channel, 12);
        ...
        private void IncrementProgress(DataMatrixChannel channel, int encodedUnits)
        {
            ...
            if (channel.EncScheme == DataMatrixScheme.SchemeC40 || channel.EncScheme == DataMatrixScheme.SchemeText)
            {
                ...
                DataMatrixTriplet triplet = GetTripletValues(channel.EncodedWords[startByte], channel.EncodedWords[startByte + 1]);
        ...
        private DataMatrixQuadruplet GetQuadrupletValues(byte cw1, byte cw2, byte cw3)
        {
            DataMatrixQuadruplet quad = new DataMatrixQuadruplet();
