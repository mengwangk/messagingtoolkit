...
namespace MessagingToolkit.Barcode.Aztec.Encoder
{
    ...
    internal sealed class State
    {
        ...
        internal static readonly State INITIAL_STATE = new State(Token.EMPTY, HighLevelEncoder.MODE_UPPER, 0, 0);
        ...
        internal int BinaryShiftByteCount
        {
            get
            {
        ...
        internal State LatchAndAppend(int mode, int value)
        {
        ...
        internal State ShiftAndAppend(int mode, int value)
        {
        ...
        internal State AddBinaryShiftChar(int index)
        {
            Token token = this.token;
            int mode = this.mode;
            int bitCount = this.bitCount;
        ...
        // Binary Shift mode.
        internal State EndBinaryShift(int index)
        {
        ...
        internal bool IsBetterThanOrEqualTo(State other)
        {
        ...
        internal BitArray ToBitArray(byte[] text)
        {
        ...
        {
            return string.Format("{0} bits={1:D} bytes={2:D}", HighLevelEncoder.MODE_NAMES[mode], bitCount, binaryShiftByteCount);
        }
    }
}
