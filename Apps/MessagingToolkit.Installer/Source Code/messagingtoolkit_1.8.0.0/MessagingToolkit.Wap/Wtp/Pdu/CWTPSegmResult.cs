...
namespace MessagingToolkit.Wap.Wtp.Pdu
{
    ...
    /// Segment result
    /// </summary>
	public class CWTPSegmResult:CWTPPDU
	{
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CWTPSegmResult"/> class.
        /// </summary>
        /// <param name="sequenceNo">The sequence no.</param>
        /// <param name="payload">The payload.</param>
        /// <param name="tid">The tid.</param>
		public CWTPSegmResult(short sequenceNo, byte[] payload, int tid):base(payload, tid, PduTypeSegmResult)
		{
