...
namespace MessagingToolkit.Core.Smpp
{
    ...
    public class SmppGatewayConfiguration : BaseConfiguration, IConfiguration
    {
        ...
        override public string ToString()
        {
            ...
            str = String.Concat(str, "BindType = ", BindType, "\r\n");
            str = String.Concat(str, "Host = ", Host, "\r\n");
            str = String.Concat(str, "NpiType = ", NpiType, "\r\n");
            str = String.Concat(str, "TonType = ", TonType, "\r\n");
            str = String.Concat(str, "Version = ", Version, "\r\n");
            str = String.Concat(str, "AddressRange = ", AddressRange, "\r\n");
            str = String.Concat(str, "Password = ", Password, "\r\n");
            str = String.Concat(str, "SystemId = ", SystemId, "\r\n");
            str = String.Concat(str, "SystemType = ", SystemType, "\r\n");
            str = String.Concat(str, "EnquireLinkInterval = ", EnquireLinkInterval, "\r\n");
            str = String.Concat(str, "SleepTimeAfterSocketFailure = ", SleepTimeAfterSocketFailure, "\r\n");
            str = String.Concat(str, "RetryAfterSocketFailure = ", RetryAfterSocketFailure, "\r\n");
            return str;
        }
    }
}
