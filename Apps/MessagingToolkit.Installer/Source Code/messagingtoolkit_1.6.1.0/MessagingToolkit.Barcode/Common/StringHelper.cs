...
namespace MessagingToolkit.Barcode.Common
{
    ...
    public sealed class StringHelper
    {
...
#else
        private static readonly String PLATFORM_DEFAULT_ENCODING = "UTF-8";
#endif
		...
		private static readonly bool ASSUME_SHIFT_JIS = SHIFT_JIS.Equals(PLATFORM_DEFAULT_ENCODING,StringComparison.InvariantCultureIgnoreCase) 
                || EUC_JP.Equals(PLATFORM_DEFAULT_ENCODING,StringComparison.InvariantCultureIgnoreCase);
