...
namespace MessagingToolkit.Barcode.Client.Results
{
    ...
    public sealed class BizcardResultParser : AbstractDoCoMoResultParser
    {
        ...
        public override ParsedResult Parse(Result result)
        {
            ...
            return new AddressBookParsedResult(ResultParser.MaybeWrap(fullName), null, BuildPhoneNumbers(phoneNumber1, phoneNumber2, phoneNumber3), null, ResultParser.MaybeWrap(email), null, null, null, addresses, null, org,
                    null, title, null);
        }
