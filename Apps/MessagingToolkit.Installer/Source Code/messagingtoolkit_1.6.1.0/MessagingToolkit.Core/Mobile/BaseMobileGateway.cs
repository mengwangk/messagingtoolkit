...
namespace MessagingToolkit.Core.Mobile
{
    ...
    internal abstract class BaseMobileGateway<T> : BaseGateway<T>, IDisposable
    {
        ...
        protected void PerformSetup()
        {
            ...
            Logger.UseSensibleDefaults(config.LogFile, config.LogLocation, LogLevel.Error);
            ...
            messageQueue = new PriorityQueue<IMessage, MessageQueuePriority>(3);
        ...
        private void LoadPersistenceQueue()
        {
            ...
            {
                List<IMessage> messages = this.messageQueue.Load();
        ...
        /// </summary>
        /// <param name="messageType">Message type. See <see cref="MessageType"/></param>
        ...
        */
        ...
        private void MessagePolling()
        {
            while (Connected)
            {
                ...
                {
                    Logger.LogThis("Polling new messages: " + e.Message, LogLevel.Error, this.Id);
                    if (!Connected) break;
