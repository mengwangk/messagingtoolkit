...
{
    /// <summary>
    /// Turn on/off calling line identification restriction
    /// </summary>
    internal sealed class ClirFeature : BaseFeature<ClirFeature>, IFeature
    {
        ...
        /// </summary>
        private const string RequestCommand = "AT+CLIR={0}";
        ...
        {
            return "ClirFeature: Turn on/off CLIR";
        }
        ...
        /// <summary>
        /// Return an instance of ClirFeature
        /// </summary>
        /// <returns>ClirFeature instance</returns>
        public static ClirFeature NewInstance()
        {
            return new ClirFeature();
        }
