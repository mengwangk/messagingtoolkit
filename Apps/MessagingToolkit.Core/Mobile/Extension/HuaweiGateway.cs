...
namespace MessagingToolkit.Core.Mobile.Extension
{
    ...
    internal class HuaweiGateway : BaseMobileGateway<HuaweiGateway>, IMobileGateway
    {
        ...
        /// Constructor
        /// </summary>
        public HuaweiGateway(MobileGatewayConfiguration config)
            : base(config)
        {
