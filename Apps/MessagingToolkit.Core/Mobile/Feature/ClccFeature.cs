...
namespace MessagingToolkit.Core.Mobile.Feature
{
    ...
    /// </summary>
    internal sealed class ClccFeature : BaseFeature<ClccFeature>, IFeature
    {
        ...
        /// </summary>
        private const string RequestCommand = "AT+ClCC={0}";
        ...
        {
            return "ClccFeature: Turn on/off ClCC";
        }
        ...
        /// <summary>
        /// Return an instance of ClccFeature
        /// </summary>
        /// <returns>ClccFeature instance</returns>
        public static ClccFeature NewInstance()
        {
            return new ClccFeature();
        }
