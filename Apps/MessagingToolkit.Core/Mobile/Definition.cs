...
namespace MessagingToolkit.Core.Mobile
{
    ...
    internal enum Response
    {
        ...
        [StringValue("[\\+]*CMS ERROR: (\\d+)[a-zA-Z\\s]*\r\n")]
        CmsError,
        /// <summary>
        /// CME error response
        /// </summary>
        [StringValue("[\\+]*CME ERROR: (\\d+)[a-zA-Z\\s]*\r\n")] // Modified Oct 19 2013
        CmeError,
        /// <summary>
    ...
    public enum CmeErrorCode
    {
        ...
        _263,
        [StringValue("CME ERROR: 515	Please wait, init or command processing in progress")]
        _515,
    ...
    public enum CallState
    {
        ...
        Waiting,
        /// <summary>
        /// Unknown. Possible rejected call
        /// </summary>
        Unknown
    }
    ...
    public enum CallMode
    {
        ...
        /// </summary>
        AlternatingVoiceDataVoice,
        /// <summary>
        /// Alternating voice/fax, voice mode
        /// </summary>
        AlternatingVoiceFaxVoice,
        /// <summary>
        ...
        /// </summary>
        AlternatingVoiceDataData,
        /// <summary>
        /// Alternating voice/fax, fax mode
        /// </summary>
        AlternatingVoiceFaxFax,
        /// <summary>
        /// Unknown
        /// </summary>
        Unknown
    ...
    /// Call control
    /// </summary>
    public enum CallControlBehavior
    {
        /// <summary>
        /// Releases all held calls or sets User Determined User Busy (UDUB) for a waiting call.
        /// If index is provided then releases a specific call X from a held multiparty call 
        /// </summary>
        [StringValue("0")]
        ReleaseHeldOrSetBusy,
        /// <summary>
        /// Releases all active calls (if any exist) and accepts the other (held or waiting) call.
        /// If index is provided then releases a specific active call X 
        /// </summary>
        [StringValue("1")]
        ReleaseActive,
        /// <summary>
        /// Places all active calls (if any exist) on hold and accepts the other (held or waiting) call.
        /// If index is provided then places all active calls on hold except call X with which communication shall be supported
        /// </summary>
        [StringValue("2")]
        PlaceActiveOnHold,
        /// <summary>
    ...
    internal static class PersistenceQueue
    {
        ...
        public static string HttpMessageFolder = "http";
    ...
    /// <summary>
    /// Persistence message type
    /// </summary>
    internal enum PersistedMessageType
    {
        /// <summary>
        /// SMS
        /// </summary>
