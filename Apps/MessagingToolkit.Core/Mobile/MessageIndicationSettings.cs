...
namespace MessagingToolkit.Core.Mobile
{
    ...
    internal sealed class MessageIndicationSettings
    {
        ...
        override public string ToString()
        {
            ...
            str = String.Concat(str, "ReceivedMessage = ", ReceivedMessage, "\r\n");
            str = String.Concat(str, "CellBroadcastMessage = ", CellBroadcastMessage, "\r\n");
            str = String.Concat(str, "StatusReport = ", StatusReport, "\r\n");
            str = String.Concat(str, "MessageBuffer = ", MessageBuffer, "\r\n");
            return str;
        }
    }
}
