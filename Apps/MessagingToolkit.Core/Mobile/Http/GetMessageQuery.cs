...
namespace MessagingToolkit.Core.Mobile.Http
{
    ...
    public sealed class GetMessageQuery
    {
        ...
        internal static string ParameterLastMessageId = "lastmessageid";
        internal static string ParameterOffset = "offset";
        internal static string ParameterRowCount = "rowcount";
        ...
        override public string ToString()
        {
            ...
            str = String.Concat(str, "Offset = ", Offset, "\r\n");
            str = String.Concat(str, "RowCount = ", RowCount, "\r\n");
            str = String.Concat(str, "LastMessageId = ", LastMessageId, "\r\n");
            return str;
        }
