...
!define PRODUCT_NAME "MessagingToolkit-Barcode"
...
;Names
Name "MessagingToolkit Barcode"
Caption "MessagingToolkit Barcode ${PRODUCT_VERSION} Setup"

; MUI Settings

!define MUI_ICON "icons\barcode.ico"
...
Section "${PRODUCT_NAME}" SEC01
  ...
  Delete "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\WinForms Demo - Barcode.lnk"
  Delete "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\WPF Demo - Barcode.lnk"
  ...
  Delete "$INSTDIR\MessagingToolkit.Barcode.WPF.Demo.exe"
  ...
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\WinForms.lnk" "$INSTDIR\Demo Clients\WinForms\MessagingToolkit.Barcode.Demo.exe"  
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\WPF.lnk" "$INSTDIR\Demo Clients\WPF\MessagingToolkit.Barcode.WPF.Demo.exe"  
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Console.lnk" "$INSTDIR\Demo Clients\Console"  
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Silverlight.lnk" "$INSTDIR\Demo Clients\Silverlight\MessagingToolkit.Barcode.Silverlight.DemoTestPage.html" 
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Windows Service.lnk" "$INSTDIR\Demo Clients\Windows Service" 
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Windows 8 - Class Library Demo.lnk" "$INSTDIR\Demo Clients\Windows 8 Class Library"
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Windows 8 - WinRT Demo.lnk" "$INSTDIR\Demo Clients\Windows 8 WinRT"  
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Windows 8 - JavaScript Demo.lnk" "$INSTDIR\Demo Clients\Windows 8 JavaScript"  
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Windows Phone 7.lnk" "$INSTDIR\Demo Clients\Windows Phone 7"  
  CreateShortCut "$SMPROGRAMS\MessagingToolkit\${PRODUCT_NAME}\Demo Clients\Windows Phone 8.lnk" "$INSTDIR\Demo Clients\Windows Phone 8"  
...
Section "Uninstall"
  ...
  RMDir /r "$INSTDIR\Demo Clients\"
  RMDir /r "$INSTDIR\Sample Source Code\"
  ;RMDir /r "$INSTDIR\MessagingToolkit.Barcode.Demo\"
  ;RMDir "$INSTDIR"
