...
namespace MessagingToolkit.Barcode.Provider
{
...
#else
    public sealed class BitmapProvider : IOutputProvider
#endif
    {
        /// <summary>
        ...
        {
            return new BitmapWrapper(RenderBitmap(bitMatrix, this.Foreground, this.Background));
        }
    ...
    /// Image wrapper class.
    /// </summary>
    public sealed class BitmapWrapper : IOutput
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="bitmap">The barcode image.</param>
