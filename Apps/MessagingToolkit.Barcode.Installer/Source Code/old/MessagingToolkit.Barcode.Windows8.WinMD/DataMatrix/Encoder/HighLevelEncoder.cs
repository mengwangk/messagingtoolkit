...
namespace MessagingToolkit.Barcode.DataMatrix.Encoder
{
    ...
    public sealed class HighLevelEncoder
    {
        ...
        /// <returns> the encoded message (the char values range from 0 to 255) </returns>
        public static string EncodeHighLevel(string msg, SymbolShapeHint shape, Dimension minSize, Dimension maxSize, IDictionary<EncodeOptions, object> encodingOptions)
        {
