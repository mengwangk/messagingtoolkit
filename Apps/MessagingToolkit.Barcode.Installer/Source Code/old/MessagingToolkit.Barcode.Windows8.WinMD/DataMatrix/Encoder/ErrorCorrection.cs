...
namespace MessagingToolkit.Barcode.DataMatrix.Encoder
{
    ...
    internal class ErrorCorrection 
    {
        ...
        /// <summary>
        /// Creates the ECC200 error correction for an encoded message. </summary>
        ...
        {
            int table = -1;
            for (int i = 0; i < FactorSets.Length; i++)
            {
            ...
            string result =  new String(eccReversed);
            return result;
        }
    }
}
