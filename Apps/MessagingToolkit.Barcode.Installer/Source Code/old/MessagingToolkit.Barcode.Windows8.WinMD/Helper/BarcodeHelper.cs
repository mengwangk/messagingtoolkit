...
namespace MessagingToolkit.Barcode.Helper
{
    ...
    internal sealed class BarcodeHelper
    {
        ...
        public static object GetDecodeOptionType(IDictionary<DecodeOptions, object> dict, DecodeOptions key)
        {
            try
            {
        ...
        public static object GetEncodeOptionType(IDictionary<EncodeOptions, object> dict, EncodeOptions key)
        {
            try
            {
                if (dict == null) return null;
