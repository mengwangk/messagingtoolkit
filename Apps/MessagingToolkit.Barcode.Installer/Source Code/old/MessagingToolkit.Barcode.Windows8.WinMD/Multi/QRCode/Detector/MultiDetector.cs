...
namespace MessagingToolkit.Barcode.Multi.QRCode.Detector
{
    ...
    /// </summary>
    internal sealed class MultiDetector : MessagingToolkit.Barcode.QRCode.Detector.Detector
    {
        ...
        public DetectorResult[] DetectMulti(IDictionary<DecodeOptions, object> decodingOptions)
        {
