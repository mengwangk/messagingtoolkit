...
namespace MessagingToolkit.Barcode.OneD
{
    ...
    /// </summary>
    internal sealed class BarcodeUPCEANDecoder : OneDDecoder
    {
        private readonly UPCEANDecoder[] decoders;

        public BarcodeUPCEANDecoder(IDictionary<DecodeOptions, object> decodingOptions)
        {
        ...
        override public Result DecodeRow(int rowNumber,
                                BitArray row,
                                IDictionary<DecodeHintType, object> decodingOptions)
        {
