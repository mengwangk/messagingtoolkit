...
namespace MessagingToolkit.Barcode.Common.ReedSolomon
{
    ...
    internal sealed class GenericGF
    {
        ...
        public static readonly GenericGF AztecData6 = new GenericGF(0x43, 64); // x^6 + x + 1
        ...
        public static readonly GenericGF DataMatrixField256 = new GenericGF(0x012D, 256); // x^8 + x^5 + x^3 + x^2 + 1
        ...
        /// </summary>
        ///
        /// <param name="primitive">coefficient</param>
